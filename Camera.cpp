...
void Camera::MoveCamera()
{
   ...
   view = lookAt(_position, _position + _lookat, _up);
}
...
void Camera::ProcessInput()
{
   ...
   if (_window.GetKeyDown(GLFW_KEY_A))
      _position -= normalize(cross(_lookat, _up)) * cameraSpeed;
...
{
   if (!_mouseButtonHeld || ImGui::GetIO().WantCaptureMouse)
      return;
